  ...
  return (
    <nav className="h-14 bg-[#161b27] border-b border-[#2a2f3e] flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="hidden md:flex items-center gap-6">
        ...
        <Link href="/#pricing" className="text-xs text-[#8892a4] hover:text-[#e2e8f0] transition-colors">Pricing</Link>
      ...
      <div className="flex items-center gap-3">
        {session ? (
          ...
          <>
            <Link href="/login" className="text-xs text-[#c8d0e0] border border-[#2a2f3e] rounded-md px-3 py-1.5 hover:bg-[#2a2f3e]/30 transition-colors">
              Sign in
            </Link>
            <Link href="/login?tab=signup" className="text-xs bg-[#534AB7] text-[#EEEDFE] font-medium px-4 py-1.5 rounded-md hover:opacity-90 transition-opacity">
              Start free
            </Link>
          </>
        )}
